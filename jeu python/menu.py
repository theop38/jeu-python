...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Jouer", 20, self.startx, self.starty)
            self.game.draw_text("Quitter", 20, self.optionsx, self.optionsy)
    ...
    def check_input(self):
        ...
        if self.game.START_KEY:
            if self.state == 'Start':
                self.game.choix_jouer = True
                self.game.playing = True
                self.game.user_choice = True
            elif self.state == 'Options':
                self.game.choix_quitter = True
                self.game.user_choice = True
            elif self.state == 'Credits':
                self.game.choix_credit = True
                self.game.user_choice = True
